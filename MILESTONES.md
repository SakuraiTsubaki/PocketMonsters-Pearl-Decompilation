# Milestones: Pocket Monsters Pearl

This roadmap governs research, tooling, analysis, reconstruction, and preservation for `SakuraiTsubaki/PocketMonsters-Pearl-Decompilation`.
...
| Field | Current value |
| --- | --- |
| Target | Pocket Monsters Pearl |
| Platform family | Nintendo DS |
| Generation | Generation IV |
| Identity status | `verified` |

The current identity status is `verified`. Existing claims remain provisional for milestone purposes until their manifests and reproduction commands satisfy the exit criteria.
...
Coordinate Nintendo DS and NARC findings with Diamond and Platinum; record every offset and layout per verified target.
