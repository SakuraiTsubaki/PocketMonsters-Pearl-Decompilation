...
|---|---:|---:|---:|---:|
| ARM9 | `0x4000` | `0x107724` (1,079,076) | `0x02000000` | `0x02000800` |
| ARM7 | `0x30D000` | `0x2931C` (168,732) | `0x02380000` | `0x02380000` |

ARM9 overlays: **87** entries (`0x10B800`, table size `0xAE0`). ARM7 overlays: **0**.
